...
cap = cv2.VideoCapture('clip1.mp4')#MUM 10.125.124.24 SBMP P-II 4_XRN-3010A_CH042(10.125.124.24)_20240911_134315_135751_ID_0100.mp4
...
# Areas of interest
count = 0
area1 = [(760,81), (683,54), (506,99), (599,155)]
area2 = [(960,116), (871,96), (818,236), (922,288)]
...
while True:    
    ...
    if cr1 >= 2:
        for person in list1:
            ...
            cvzone.putTextRect(frame, f'intruder', (x1, y1), 1, 1)
    else:
        for person in list1:
            x1, y1, w, h, cx, cy = person
